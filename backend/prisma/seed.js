...
async function main() {
  ...
  // ─── Products ───────────────────────────────
  await prisma.product.upsert({ where: { id: 'bp' },      update: { name: 'Blood Pressure Monitor',         subtitle: 'Omron HEM-7140T1-AP BP Monitor',                                                                                           description: 'Clinically validated BP monitoring with IntelliSense™ technology, Bluetooth connectivity, and one-touch simplicity for daily use.', price: 2000, originalPrice: 2560, rating: 4.8, reviewCount: 1087, featuresTitle: 'Captures cardiovascular vital parameters:',       productType: 'individual', displayOrder: 1 }, create: { id: 'bp',      name: 'Blood Pressure Monitor',         subtitle: 'Omron HEM-7140T1-AP BP Monitor',                                                                                           description: 'Clinically validated BP monitoring with IntelliSense™ technology, Bluetooth connectivity, and one-touch simplicity for daily use.', price: 2000, originalPrice: 2560, rating: 4.8, reviewCount: 1087, featuresTitle: 'Captures cardiovascular vital parameters:',       productType: 'individual', displayOrder: 1 } });
  await prisma.product.upsert({ where: { id: 'glucose' }, update: { name: 'Glucose Monitor',                  subtitle: 'RGB GlucoBuddy BLE Glucometer',                                                                                            description: 'Fast, accurate blood glucose tracking with Bluetooth, 900-test memory, and meal-time logging for smarter diabetes care.',          price: 1000, originalPrice: 1600, rating: 4.6, reviewCount: 489,  featuresTitle: 'Captures diabetes monitoring parameters:',       productType: 'individual', displayOrder: 2 }, create: { id: 'glucose', name: 'Glucose Monitor',                  subtitle: 'RGB GlucoBuddy BLE Glucometer',                                                                                            description: 'Fast, accurate blood glucose tracking with Bluetooth, 900-test memory, and meal-time logging for smarter diabetes care.',          price: 1000, originalPrice: 1600, rating: 4.6, reviewCount: 489,  featuresTitle: 'Captures diabetes monitoring parameters:',       productType: 'individual', displayOrder: 2 } });
  await prisma.product.upsert({ where: { id: 'scale' },   update: { name: 'Body Composition Scale',          subtitle: 'MEDITIVE Body Composition Scale',                                                                                          description: 'Go beyond weight. Track BMI, body fat, muscle mass, metabolism, and hydration with an app-connected precision scale.',            price: 1000, originalPrice: 2999, rating: 4.5, reviewCount: 312,  featuresTitle: 'Captures multiple body composition parameters:', productType: 'individual', displayOrder: 3 }, create: { id: 'scale',   name: 'Body Composition Scale',          subtitle: 'MEDITIVE Body Composition Scale',                                                                                          description: 'Go beyond weight. Track BMI, body fat, muscle mass, metabolism, and hydration with an app-connected precision scale.',            price: 1000, originalPrice: 2999, rating: 4.5, reviewCount: 312,  featuresTitle: 'Captures multiple body composition parameters:', productType: 'individual', displayOrder: 3 } });
  await prisma.product.upsert({ where: { id: 'complete-essentials' }, update: { name: 'Complete health essentials',     subtitle: 'Omron HEM-7140T1-AP BP Monitor + RGB GlucoBuddy BLE Glucometer + MEDITIVE Body Composition Scale', description: 'Comprehensive health monitoring for the whole family — blood pressure, blood sugar, and body composition, all connected to Total Care.', price: 3899, originalPrice: 7159, rating: 4.8, reviewCount: 1240, featuresTitle: 'Tracks all essential everyday health indicators:',          productType: 'bundle', displayOrder: 4 }, create: { id: 'complete-essentials', name: 'Complete health essentials',     subtitle: 'Omron HEM-7140T1-AP BP Monitor + RGB GlucoBuddy BLE Glucometer + MEDITIVE Body Composition Scale', description: 'Comprehensive health monitoring for the whole family — blood pressure, blood sugar, and body composition, all connected to Total Care.', price: 3899, originalPrice: 7159, rating: 4.8, reviewCount: 1240, featuresTitle: 'Tracks all essential everyday health indicators:',          productType: 'bundle', displayOrder: 4 } });
  await prisma.product.upsert({ where: { id: 'bp-essentials' },       update: { name: 'Blood pressure care essentials', subtitle: 'Omron HEM-7140T1-AP BP Monitor + MEDITIVE Body Composition Scale',                                          description: 'Monitor blood pressure and body composition together for a complete cardiovascular health picture, every single day.',                  price: 2899, originalPrice: 5559, rating: 4.7, reviewCount: 892,  featuresTitle: 'Tracks key cardiovascular and body health indicators:',    productType: 'bundle', displayOrder: 5 }, create: { id: 'bp-essentials',       name: 'Blood pressure care essentials', subtitle: 'Omron HEM-7140T1-AP BP Monitor + MEDITIVE Body Composition Scale',                                          description: 'Monitor blood pressure and body composition together for a complete cardiovascular health picture, every single day.',                  price: 2899, originalPrice: 5559, rating: 4.7, reviewCount: 892,  featuresTitle: 'Tracks key cardiovascular and body health indicators:',    productType: 'bundle', displayOrder: 5 } });
  await prisma.product.upsert({ where: { id: 'diabetes-essentials' }, update: { name: 'Diabetes care essentials',        subtitle: 'RGB GlucoBuddy BLE Glucometer + MEDITIVE Body Composition Scale',                                           description: 'Track blood glucose and body composition with Bluetooth-connected devices designed for confident daily diabetes management.',           price: 1999, originalPrice: 4599, rating: 4.6, reviewCount: 643,  featuresTitle: 'Tracks key diabetes and body health indicators:',          productType: 'bundle', displayOrder: 6 }, create: { id: 'diabetes-essentials', name: 'Diabetes care essentials',        subtitle: 'RGB GlucoBuddy BLE Glucometer + MEDITIVE Body Composition Scale',                                           description: 'Track blood glucose and body composition with Bluetooth-connected devices designed for confident daily diabetes management.',           price: 1999, originalPrice: 4599, rating: 4.6, reviewCount: 643,  featuresTitle: 'Tracks key diabetes and body health indicators:',          productType: 'bundle', displayOrder: 6 } });
