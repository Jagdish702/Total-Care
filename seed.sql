...
INSERT INTO testimonials (person_name, quote, product_id, context, display_order) VALUES
...
('Neha Kulkarni', 'I used to check my sugar levels but never really understood them fully. Now I can clearly see patterns — what affects my levels, what doesn''t, and how to manage them better.',              'glucose', 'product', 3);
...
(5, 'Is there a subscription required to use TotalCare?',
    'text',
    'Yes. Choose a Quarterly plan at ₹99/month (billed ₹297 for first 3 months) or a Yearly plan at ₹999/year. Both plans include the full suite of services.',
    3, 5),
...
-- 38. status_cards — card definitions
INSERT INTO status_cards (id, title, description, icon_name, card_type, linked_product_id, linked_service_id, unit, display_order) VALUES
...
-- 39. status_card_levels — per-card level definitions
INSERT INTO status_card_levels (card_id, level_key, label, description, color_hex, bg_color_hex, icon_name, display_order) VALUES

-- Blood Pressure
('blood-pressure', 'normal',   'Normal',        'Systolic 90–120 mmHg and diastolic 60–80 mmHg.',          '#00B82E', '#E8F8EE', 'iconCheckCircle', 1),
('blood-pressure', 'elevated', 'Elevated',      'Systolic 120–129 mmHg; diastolic below 80 mmHg.',         '#D29300', '#FFF8E1', 'iconAlertCircle', 2),
('blood-pressure', 'warning',  'High — Stage 1','Systolic 130–139 mmHg or diastolic 80–89 mmHg.',          '#FF7A00', '#FFF0E0', 'iconWarning',     3),
('blood-pressure', 'critical', 'High — Stage 2','Systolic 140+ mmHg or diastolic 90+ mmHg.',               '#E53935', '#FDECEA', 'iconCritical',    4),
('blood-pressure', 'pending',  'No Reading',    'No recent reading available. Sync your device.',           '#808080', '#F5F5F5', 'iconSync',        5),

-- Blood Glucose
('blood-glucose', 'normal',   'Normal',         'Fasting: 70–99 mg/dL. Post-meal: below 140 mg/dL.',       '#00B82E', '#E8F8EE', 'iconCheckCircle', 1),
('blood-glucose', 'warning',  'Pre-diabetic',   'Fasting: 100–125 mg/dL. Monitor closely.',                '#FF7A00', '#FFF0E0', 'iconWarning',     2),
...
-- Body Weight & BMI
('body-weight', 'normal',   'Healthy',          'BMI 18.5–24.9. Keep it up!',                              '#00B82E', '#E8F8EE', 'iconCheckCircle', 1),
('body-weight', 'warning',  'Overweight',       'BMI 25–29.9. Consider dietary adjustments.',              '#FF7A00', '#FFF0E0', 'iconWarning',     2),
...
-- Heart Rate
('heart-rate', 'normal',   'Normal',            'Resting heart rate 60–100 BPM.',                          '#00B82E', '#E8F8EE', 'iconCheckCircle', 1),
...
-- 7 payment status levels — level_key mirrors payments.status CHECK values exactly
INSERT INTO status_card_levels (card_id, level_key, label, description, color_hex, bg_color_hex, icon_name, display_order) VALUES
...
('payment', 'processing',  'Processing',  'Payment submitted to the gateway — awaiting confirmation.',                  '#0072CF', '#E3F0FB', 'iconClock',       3),
('payment', 'pending',     'Pending',     'Initiated but not yet submitted — e.g. redirected to bank.',                 '#D29300', '#FFF8E1', 'iconAlertCircle', 4),
('payment', 'refunded',    'Refunded',    'Payment successfully reversed. Amount returns within 5–7 business days.',    '#7B61FF', '#F0EEFF', 'iconRefund',      5),
...
-- 40. status_card_metrics — numeric thresholds per card
INSERT INTO status_card_metrics (card_id, metric_key, metric_label, metric_unit, normal_min, normal_max, warning_min, warning_max, critical_min, critical_max, display_order) VALUES
